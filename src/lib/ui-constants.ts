export const UI_CONSTANTS = {
  ...
  states: {
    ...
    focus:
      "focus:outline-none focus:ring-2 focus:ring-[#00c4cc] focus:ring-offset-2",
...
export const createCardClasses = (
  ...
  return cn(baseClasses, borderClasses[variant], backgroundClasses[variant]);
};
...
export const createTabsTriggerClasses = (
  ...
  if (isActive) {
    const activeClasses = {
      ...
      accent: cn(UI_CONSTANTS.colors.primary, "text-white shadow-sm"),
      soft: cn("bg-white text-[#00c4cc] shadow-sm", "border border-[#cffafe]"),
    };
    return cn(baseClasses, activeClasses[variant]);
  }

  const inactiveClasses = {
    primary: cn("text-[#4b5563] hover:text-[#00c4cc]", "hover:bg-white/50"),
    accent: cn("text-[#4b5563] hover:text-[#00c4cc]", "hover:bg-white/50"),
    soft: cn("text-[#4b5563] hover:text-[#00c4cc]", "hover:bg-white/50"),
  };
