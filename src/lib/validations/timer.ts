...
export type UpdateTimerSequenceInput = z.infer<typeof updateTimerSequenceSchema>;
...
// バリデーション実行ヘルパー
export const validateCreateTimer = (data: unknown): ValidationResult<CreateTimerInput> => {
  try {
...
export const validateUpdateTimer = (data: unknown): ValidationResult<UpdateTimerInput> => {
  try {
...
export const validateDeleteTimer = (data: unknown): ValidationResult<DeleteTimerInput> => {
  try {
