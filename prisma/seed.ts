  ...
  const articles = await Promise.all([
    prisma.article.create({
      data: {
        ...
        description:
          "React Hooksについての詳しい解説記事。useStateからuseEffectまで幅広くカバーします。",
    ...
    prisma.article.create({
      data: {
        ...
        description:
          "ES2024の新機能や最新のJavaScript開発手法について解説します。",
    ...
    prisma.article.create({
      data: {
        ...
        description:
          "Vue.js 3のComposition APIを使った効率的な開発方法を紹介します。",
    ...
    prisma.article.create({
      data: {
        ...
        description:
          "TypeScriptの型システムを活用した安全なアプリケーション開発手法について",
    ...
    prisma.article.create({
      data: {
        ...
        description:
          "Core Web Vitalsを改善するための実践的なテクニックを紹介します。",
